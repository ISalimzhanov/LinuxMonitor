...
public class X11Api {
     ...
     * {@link X11Api.Display#setModifierKeymap(ModifierKeymap)}.
     */
    ...
    public static class Window {
        private X11Api.Display display;
         ...
         */
        public Window(X11Api.Display display, X11.Window x11Window) {
            this.display = display;
